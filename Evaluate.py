...
def produce_musdb_source_estimates(model_config, load_model, musdb_path, output_path, subsets='test', yaml_path=None):
    '''
    ...
    mus = musdb.DB(root_dir=musdb_path, setup_file=yaml_path)
